...
public class ProductServiceClientContractTest {
    ...
    private final String SAMPLE_BEARER_TOKEN = "Bearer AAABd9yHUjI=";
    ...
    public V4Pact getAllProducts(PactDslWithProvider builder) {
        ...
        return builder
                ...
                .method("GET")
                .path("/api/products")
                .matchHeader("Authorization", REGEX_BEARER_TOKEN, SAMPLE_BEARER_TOKEN) // Regex to match "Bearer 19" or "20" followed by alphanumeric characters
    ...
    public V4Pact getProductDetailsById(PactDslWithProvider builder) {
        return builder
                ...
                .matchHeader("Authorization", REGEX_BEARER_TOKEN, SAMPLE_BEARER_TOKEN)
                .willRespondWith()
                .status(200)
                .headers(HEADERS)
                .body(
